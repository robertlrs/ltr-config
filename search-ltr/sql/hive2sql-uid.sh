...
#echo "begin-------------------------------${db}:${table}------------------------------"
 ...
 sqoop export --connect jdbc:mysql://172.16.8.4:3306/warehouse --username datateam --password  RJ4f84S4RjfRxRMm  --table dj_search_uid_ctr --export-dir hdfs://hadoop-manager:8020/user/hive/warehouse/zhouyf.db/search_uid_ctr --input-fields-terminated-by '\001' --input-null-non-string '\\N' --input-null-string '\\N' --update-mode allowinsert --update-key uid
